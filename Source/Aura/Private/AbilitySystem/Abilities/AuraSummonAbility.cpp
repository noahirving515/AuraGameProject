...
TArray<FVector> UAuraSummonAbility::GetSpawnLocations()
{
	...
	for (int32 i = 0; i < NumMinions; i++)
	{
		...
		DrawDebugSphere(GetWorld(), ChosenSpawnLocation, 18, 12, FColor::Green, false, 3.f);
		
		UKismetSystemLibrary::DrawDebugArrow(GetAvatarActorFromActorInfo(), Location, Location + Direction * MaxSpawnDistance, 4, FLinearColor::Green, 3.f);
